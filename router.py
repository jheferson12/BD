...
from models import EmployeeCreate, Employee,Customer,CustomerCreate,OrderCreate,Order,MenuCreate, Menu,OrderDetailCreate, OrderDetail,UploadCreate, Upload
...
def create_customer(customer: CustomerCreate):
    ...
    try:
        ...
        conn.commit()
        created_customer = Customer(customer_id=cursor.lastrowid, **customer.dict())
